...
Простое и удобное взаимодействие с базами данных PostgreSQL и SQLite. Подходит для небольших или пэт проектов, когда необходима быстрая интекрация с БД без подключения ORM .
